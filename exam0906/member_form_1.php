...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <script>
            function idChk() {
                var idChkModal = document.getElementById("userID").value;
                var modalTitle = document.getElementById("userID").value;
            }
            function check_nick() {
    ...
    <body>
        <form name="member_form" method="post" action="insert.php">
            <table>
                <tr>
                    ...
                    <td width="900px"><input type="text" align="center" name="id"><button type="button" id = "userID" class="btn-primary" alt="" align="center" data-toggle='modal' onclick="idChk()" data-target='#idChk'>중복체크</button>
        ...
        <div class='modal fade' id='idChk' role='dialog'>
            <div class='modal-dialog' style="width:500px">
                <div class='modal-content'>
                    <div class='modal-header' style='background: yellowgreen'>
                        ...
                        <h5 id="modalTitle1">타이틀</h5>
                    </div>
                    <div class='modal-body'>
                        <h5 id="modalBody1">내용</h5>
                    </div>
                    <div class='modal-footer'>
                        <button class='btn btn-default' data-toggle='modal' data-dismiss='modal'>닫기</button>
                    </div>
                </div>
            </div>
        </div>
